"""
This module sets up logging and defines the ResultCalculator class.
The ResultCalculator class is used to calculate and log the results of a kernel search strategy.
"""
...
class ResultCalculator:
    """
    A class to calculate and log the results of a kernel search strategy.

    Attributes:
        conn (mysql.connector.connection.MySQLConnection): The database connection.
        kernelStrategy (KernelStrategy): The kernel strategy used for the search.
        dataset (DataSet): The dataset used for the search.
        search_strategy (Search): The search strategy used.
        tree (HittingSetTree): The search tree generated by the strategy.
        execution_time (float): The time taken to execute the search.
        resources (str): The resources used during the execution.
        output_file (str): The file path to write the results to.
        value (str): The value parameter used in the search.
    """

    def __init__(self, conn, kernelStrategy, dataset, search_strategy, tree, execution_time, resources, output_file, value):
        """
        Initialize the ResultCalculator with the required parameters.
        ...
        self.result = {
            ...
            'min_card_max_value_incon': None,
            'optimal_solution_found': False
        }

    def create_leaf_node_dict(self):
        """
        Create a list of tuples containing (BBVALUE, hitting_set, LEAF_NODE) and sort them in descending order.
    ...
    def sort_leaf_nodes_asc(self):
        """
        Sort the leaf nodes based on BBVALUE (ascending) and then Cardinality (ascending).
    ...
    def sort_leaf_nodes_desc(self):
        """
        Sort the leaf nodes based on BBVALUE (descending) and then Cardinality (ascending).
    ...
    def print_results(self):
        """
        Print the results of the execution to the console.
    ...
    def print_cnf_repair(self):
        """
        Print the CNF repair to a file.
    ...
    def print_baseline_results_to_file(self):
        """
        Print the baseline results to a CSV file.
    ...
    def log_results(self):
        """
        Log the execution data to the database.
    ...
    def calculate(self):
        """
        Calculate various result parameters and determine if the optimal solution is found.
    ...
    def get_values_from_db(self):
        """
        Retrieve and assign values from the database to the result dictionary.
